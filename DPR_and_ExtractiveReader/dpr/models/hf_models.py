...
from .extractive_reader import (
    set_default_extractive_reader_loss_cfg,
    Reader,
)
...
def get_bert_reader_components(cfg, inference_only: bool = False, **kwargs):
    ...
    set_default_extractive_reader_loss_cfg(
        _use_answer_indicator=cfg.use_answer_indicator,
        _train_sigmoid_answer_indicator=cfg.train_sigmoid_answer_indicator,
        _global_loss_type=cfg.train.global_loss_type,
        _global_loss_coeff=cfg.train.global_loss_coeff,
        _local_loss_type=cfg.train.local_loss_type,
        _local_loss_coeff=cfg.train.local_loss_coeff,
        _anneal_steps=cfg.train.anneal_steps,
    )
    reader = Reader(encoder, hidden_size, 
                    use_answer_indicator=cfg.use_answer_indicator)
...
class BertTensorizer(Tensorizer):
    ...
    def tokenize(self, text: str):
        return self.tokenizer.tokenzie(text)
