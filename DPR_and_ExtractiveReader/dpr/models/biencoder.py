...
def dot_product_scores(q_vectors: T, ctx_vectors: T, normalize=False) -> T:
    """
...
class BiEncoderNllLoss(object):
    def calc(
        ...
        """
        scores = self.get_scores(q_vectors, ctx_vectors, normalize)
    ...
    @staticmethod
    def get_scores(q_vector: T, ctx_vectors: T, normalize=False) -> T:
        f = BiEncoderNllLoss.get_similarity_function()
        return f(q_vector, ctx_vectors, normalize)
